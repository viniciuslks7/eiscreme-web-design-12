  ...
  return (
    <div className="relative min-h-screen w-full bg-white overflow-hidden">
      ...
      <div className="absolute w-[216px] h-[49px] left-[60.15px] top-[173px]">
        <h2 
          className="absolute w-[216px] h-[49px] left-[calc(50%-216px/2-547.85px)] top-[173px] font-nunito font-black text-[36px] leading-[49px] text-[#349882]"
        >
          SOBRE NÓS
        </h2>
      </div>
      ...
      {/* Footer */}
      <div 
        className="absolute w-[1475px] h-[86px] left-[calc(50%-1475px/2-3.5px)] top-[770px] bg-[#48B9A0] rounded-[45.0387px] flex items-center justify-center"
      >
        <p 
          className="absolute w-[424px] h-[33px] left-[calc(50%-424px/2)] top-[780px] font-nunito font-semibold text-[24px] leading-[33px] text-white"
        >
